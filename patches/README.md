...
The apply scripts also recognize and replace the earlier fallback body, so re-running them upgrades installations that already carry the previous patch revision.
